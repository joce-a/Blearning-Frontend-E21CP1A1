...
function lawyeria_lite_enqueue_style() {
    ...
    //EL QUE VIENE ES EL QUE AGREGUÉ YO
    wp_enqueue_style( 'lawyeria_lite_custom', get_theme_file_uri( '/css/custom.css'), null, $theme_data->get( 'Version' ), 'screen');
   
    //OTRO SCRIPT
    wp_enqueue_style( 'twentytwenty', get_template_directory_uri() . '/css/twentytwenty.css', array(), '1.0' );
...
function lawyeria_lite_enqueue_scripts() {
    ...
    //SCRIPT EXTRA ADD BY ME
    wp_enqueue_script ( ' event.move ', get_template_directory_uri() . '/js/jquery.event.move.js', array( 'jquery' ), '1.0', true );
    wp_enqueue_script ( ' twentytwenty ', get_template_directory_uri() . '/js/jquery.twentytwenty.js', array( 'jquery' ), '1.0', true );
